...
<span id="home_header_img">
  <section class="home-section-1" style="background: url(<?php echo get_theme_mod($home_header_img)?>); background-repeat: no-repeat;
    ...
    <div class="section-1-heading">
      <span id="home_header_title"><h1 class="section-1-title"> <?php echo nl2br(get_theme_mod($home_header_title))?> </h1></span>
      <span id="home_header_p"><p class="title-text"><?php echo get_theme_mod($home_header_p)?> </p></span>
...
<div class="next-step-section">
  ...
  <div class="page-box-container">
      <div class="next-step-box" id="giving-rides-box">
        ...
        <span id="home_giving_box"><p class="box-description box-description-black"><?php  echo get_theme_mod($home_giving_box); ?></p></span>
      ...
      <div class="next-step-box" id="receiving-rides-box">
        ...
        <span id="home_receiving_box"><p class="box-description box-description-white"><?php  echo get_theme_mod($home_receiving_box); ?></p></span>
      ...
      <div class="next-step-box" id="contact-us-box">
        ...
        <span id="home_contact_box"><p class="box-description box-description-black"><?php  echo get_theme_mod($home_contact_box); ?></p></span>
      ...
      <div class="next-step-box" id="donate-page-box">
        ...
        <span id="home_donate_box"><p class="box-description box-description-white"><?php  echo get_theme_mod($home_donate_box); ?></p></span>
      ...
      <div class="next-step-box" id="fares-page-box">
        ...
        <span id="home_fares_box"><p class="box-description box-description-black"><?php  echo get_theme_mod($home_fares_box); ?></p></span>
      ...
      <div class="next-step-box" id="volunteer-with-us-box">
        ...
        <span id="home_volunteer_box"><p class="box-description box-description-white"><?php  echo get_theme_mod($home_volunteer_box); ?></p></span>
